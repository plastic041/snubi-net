...
const PostHeader = ({ frontmatter }: PostHeaderProps) => {
  return (
    ...
    >
      <Link href="/posts">
        <a className="transition-colors flex items-center gap-2 self-start text-gray-500 duration-200 hover:text-gray-900 dark:text-gray-200 dark:hover:text-gray-400">
